  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-paper px-4 py-10">
      <Link href="/" className="mb-8 flex items-center gap-2">
        <span className="grid h-9 w-9 place-items-center rounded-lg bg-accent font-heading text-lg font-bold text-white">
          Q
        </span>
        <span className="font-heading text-2xl font-semibold tracking-tight">Quotebook</span>
      </Link>
